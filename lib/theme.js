...
export const T = {
  ...
  // Solid black (same as `ink`) rather than `line`'s translucent hairline —
  // used for form-field borders specifically, which need to read clearly as
  // tappable boxes; paired with a thin 1px width so full-black still doesn't
  // look heavy.
  fieldLine: '#16140F',
