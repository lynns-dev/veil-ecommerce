...
export const T = {
  ...
  // Darker than `line` — used for form-field borders specifically, which
  // need to read clearly as tappable boxes rather than fade into the page
  // background the way a hairline divider is supposed to.
  fieldLine: 'rgba(22,20,15,0.32)',
  // Savings/free-gift indicator (checkout's "You saved" line, "FREE" tags,
  // discount/promo rows) — the one spot of color against the otherwise
  // black/white/warm-neutral palette, since a savings amount is meant to
  // pop rather than blend in like the rest of this minimal theme.
  green: '#2F6B45',
  maxw: '1400px',
